...
class SkinnedMeshRendererUpdate(_message.Message):
    ...
    class Bones(_message.Message):
        ...
        def __init__(
            self,
            ids: _Optional[
                _Iterable[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]]
            ] = ...,
        ) -> None: ...
    ...
    class BlendShapeWeights(_message.Message):
        ...
        class BlendShapeWeight(_message.Message):
            ...
            weight: float
            def __init__(
                self, index: _Optional[int] = ..., weight: _Optional[float] = ...
            ) -> None: ...
    ...
    def __init__(
        self,
        id: _Optional[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]] = ...,
        mesh_id: _Optional[_Union[_identifiers_pb2.AssetIdentifier, _Mapping]] = ...,
        root_bone_id: _Optional[
            _Union[_identifiers_pb2.ComponentIdentifier, _Mapping]
        ] = ...,
        bones: _Optional[_Union[SkinnedMeshRendererUpdate.Bones, _Mapping]] = ...,
