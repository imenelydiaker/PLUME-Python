...
class TransformUpdate(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]] = ...,
        parent_transform_id: _Optional[
            _Union[_identifiers_pb2.ComponentIdentifier, _Mapping]
        ] = ...,
        sibling_idx: _Optional[int] = ...,
        local_position: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ...,
        local_rotation: _Optional[_Union[_quaternion_pb2.Quaternion, _Mapping]] = ...,
