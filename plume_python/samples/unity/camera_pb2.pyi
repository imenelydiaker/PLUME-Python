...
class CameraUpdate(_message.Message):
    ...
    USE_JITTERED_PROJECTION_MATRIX_FOR_TRANSPARENT_RENDERING_FIELD_NUMBER: _ClassVar[
        int
    ]
    ...
    def __init__(
        ...
        rendering_path: _Optional[_Union[_rendering_pb2.RenderingPath, str]] = ...,
        allow_hdr: bool = ...,
        allow_msaa: bool = ...,
        allow_dynamic_resolution: bool = ...,
        force_into_render_texture: bool = ...,
        ...
        orthographic: bool = ...,
        opaque_sort_mode: _Optional[_Union[_rendering_pb2.OpaqueSortMode, str]] = ...,
        transparency_sort_mode: _Optional[
            _Union[_rendering_pb2.TransparencySortMode, str]
        ] = ...,
        transparency_sort_axis: _Optional[_Union[_vector3_pb2.Vector3, _Mapping]] = ...,
        ...
        use_occlusion_culling: bool = ...,
        culling_matrix: _Optional[_Union[_matrix4x4_pb2.Matrix4x4, _Mapping]] = ...,
        ...
        projection_matrix: _Optional[_Union[_matrix4x4_pb2.Matrix4x4, _Mapping]] = ...,
        ...
        stereo_target_eye: _Optional[_Union[CameraStereoTargetEyeMask, str]] = ...,
    ) -> None: ...
