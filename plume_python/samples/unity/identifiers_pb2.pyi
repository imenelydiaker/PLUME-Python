...
class GameObjectIdentifier(_message.Message):
    ...
    transform_id: str
    def __init__(
        self, game_object_id: _Optional[str] = ..., transform_id: _Optional[str] = ...
    ) -> None: ...
...
class ComponentIdentifier(_message.Message):
    ...
    def __init__(
        ...
        parent_id: _Optional[_Union[GameObjectIdentifier, _Mapping]] = ...,
    ) -> None: ...
...
class AssetIdentifier(_message.Message):
    ...
    path: str
    def __init__(
        self, id: _Optional[str] = ..., path: _Optional[str] = ...
    ) -> None: ...
...
class SceneIdentifier(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        runtime_index: _Optional[str] = ...,
        name: _Optional[str] = ...,
        path: _Optional[str] = ...,
        build_index: _Optional[int] = ...,
