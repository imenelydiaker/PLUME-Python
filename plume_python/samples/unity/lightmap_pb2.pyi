...
class LightmapsUpdate(_message.Message):
    ...
    def __init__(
        ...
        lightmaps_data: _Optional[_Iterable[_Union[LightmapData, _Mapping]]] = ...,
    ) -> None: ...

class LightmapData(_message.Message):
    __slots__ = [
        "lightmap_color_texture_id",
        "lightmap_dir_texture_id",
        "lightmap_shadow_mask_texture_id",
    ]
    ...
    def __init__(
        self,
        lightmap_color_texture_id: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        lightmap_dir_texture_id: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        lightmap_shadow_mask_texture_id: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
    ) -> None: ...
