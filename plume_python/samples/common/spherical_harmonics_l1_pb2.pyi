...
class SphericalHarmonicsL1(_message.Message):
    ...
    def __init__(
        self,
        shAr: _Optional[_Union[_vector4_pb2.Vector4, _Mapping]] = ...,
        shAg: _Optional[_Union[_vector4_pb2.Vector4, _Mapping]] = ...,
        shAb: _Optional[_Union[_vector4_pb2.Vector4, _Mapping]] = ...,
    ) -> None: ...
