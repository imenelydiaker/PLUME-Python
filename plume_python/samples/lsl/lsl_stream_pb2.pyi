...
class StreamSample(_message.Message):
    ...
    def __init__(
        ...
        float_values: _Optional[_Union[StreamSample.RepeatedFloat, _Mapping]] = ...,
        double_values: _Optional[_Union[StreamSample.RepeatedDouble, _Mapping]] = ...,
        string_values: _Optional[_Union[StreamSample.RepeatedString, _Mapping]] = ...,
        int8_values: _Optional[_Union[StreamSample.RepeatedInt8, _Mapping]] = ...,
        int16_values: _Optional[_Union[StreamSample.RepeatedInt16, _Mapping]] = ...,
        int32_values: _Optional[_Union[StreamSample.RepeatedInt32, _Mapping]] = ...,
        int64_values: _Optional[_Union[StreamSample.RepeatedInt64, _Mapping]] = ...,
    ) -> None: ...
